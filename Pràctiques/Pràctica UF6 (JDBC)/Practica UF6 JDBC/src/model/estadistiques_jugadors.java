...
public class estadistiques_jugadors {
    ...
    int jugador_id, partit_id, punts, tirs_anotats, tirs_tirats, tirs_triples_anotats, tirs_triples_tirats, tirs_lliures_anotats, tirs_lliures_tirats, rebots_ofensius, rebots_defensius, asistencies, robades, bloqueigs;
    double minuts_jugats;

    public estadistiques_jugadors(int jugador_id, int partit_id, int punts, int tirs_anotats, int tirs_tirats, int tirs_triples_anotats, int tirs_triples_tirats, int tirs_lliures_anotats, int tirs_lliures_tirats, int rebots_ofensius, int rebots_defensius, int asistencies, int robades, int bloqueigs, double minuts_jugats) {
    ...
    public void setAsistencies(int asistencies) {
        this.asistencies = asistencies;
    }
