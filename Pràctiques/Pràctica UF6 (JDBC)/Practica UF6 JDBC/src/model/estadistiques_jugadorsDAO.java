...
public class estadistiques_jugadorsDAO implements DAO<estadistiques_jugadors> {
    ...
    public boolean update(estadistiques_jugadors e) {
        ...
        try {
            ...
            ps.setDouble(1, e.getMinuts_jugats());
            ps.setInt(2, e.getPunts());
            ps.setInt(3, e.getTirs_anotats());
            ps.setInt(4, e.getTirs_tirats());
            ps.setInt(5, e.getTirs_triples_anotats());
            ps.setInt(6, e.getTirs_triples_tirats());
            ps.setInt(7, e.getTirs_lliures_anotats());
            ps.setInt(8, e.getTirs_lliures_tirats());
            ps.setInt(9, e.getRebots_ofensius());
            ps.setInt(10, e.getRebots_defensius());
            ps.setInt(11, e.getAsistencies());
            ps.setInt(12, e.getRobades());
            ps.setInt(13, e.getBloqueigs());
            ps.setInt(14, e.getJugador_id());
            ps.setInt(15, e.getPartit_id());
            ps.executeUpdate();
        } catch (Exception ex) {
